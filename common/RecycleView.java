package com.mine.procurementcopy.common;
...
import com.mine.procurementcopy.R;
...
public class RecycleView extends AppCompatActivity {
    ...
    ArrayList<PojoMethods> rlist = new ArrayList<>();
...
//        rv = findViewById(R.id.recycle);
        ...
        PojoMethods setMethods = new PojoMethods();
    ...
    * */
    public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder>{
        ...
        public RecyclerAdapter(Context context,  ArrayList<PojoMethods> rlist) {
...
/*            getting the layout which we need to list in the manner(how we designed in the layout)
            ...
            ==> Here the parent is to view the how many records that occur in database(if list from database,
             otherwise the list that we created statically)
 */
            inflater = LayoutInflater.from(context);
            View view =inflater.inflate(R.layout.recycle_field_recent,parent,false);
...
//            To click on the item in a list 
...
// Calling the respective key value in the UpdateDetails(where the value needed means mandal in the mandal method village in the village)

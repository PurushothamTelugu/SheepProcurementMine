...
public class CPTDashBoard extends AppCompatActivity {

    TextView minsurance_uploaded_pend,minsurance_uploaded,mtotal_entries_on_sheep,mtoday_entries_text,mreport;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cptd);

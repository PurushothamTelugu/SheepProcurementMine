...
import com.mine.procurementcopy.common.Utilities;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
         ...
         // new AuthTask().execute().get();
                String responce_loan = null;
                try {
                    responce_loan = new CheckLogin().execute().get();
                    sharePref = getApplicationContext().getSharedPreferences("procurement", 0);
                    Log.d("response-----",responce_loan);

                    try
                    {

                        j = new JSONObject(responce_loan);
                        ...
                        for( int i=0; i < jsonArray.length(); i++ )
                        {
                            ...
                            if(jsonObject1.getInt("Role")==32) {
                               ...
                               // editor.putString("session_id",session_id);
                                ...
                                editor.commit();
                                startActivity(new Intent(LoginActivty.this, CPTDashBoard.class));
                            ...
                            }else if (jsonObject1.getString("Action").equalsIgnoreCase("DA") ){

                                startActivity(new Intent(LoginActivty.this, DADashBoard.DADDashBoard.class));
